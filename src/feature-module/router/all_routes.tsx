export const all_routes = {
  ...
  adminSiteSelection: "/admin/site-selection",
  adminEmployeesBySite: "/admin/employees",
  ...
  scheduleTask: "/crm/schedule-task",
  ...
  // Payroll Routes
  payslipGenerator: "/payroll/payslip-generator",
  professionalTaxRules: "/payroll/professional-tax-rules",
  statutoryRules: "/payroll/statutory-rules",
  payrollSettings: "/payroll/settings",
  employeePayrollConfig: "/payroll/employee-payroll-config",
  employeeAdvance: "/payroll/employee-advance",
  runPayroll: "/payroll/run-payroll",
