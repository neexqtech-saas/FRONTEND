  ...
  useEffect(() => {
    if (editingCategory) {
      setFormData({
        ...
        color_code: editingCategory.color_code || "#3498db",
      });
    } else {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (editingCategory) {
        ...
        let url = `http://127.0.0.1:8000/api/expense-categories/${site_id}/${editingCategory.id}/`;
      ...
      // Close modal
      const modalElement = document.getElementById("expenseCategoryModal");
      if (modalElement) {
      ...
      toast.error(
        ...
        `Failed to ${editingCategory ? "update" : "create"} expense category`
      );
    } finally {
      setLoading(false);
    }
      ...
      <div className="modal-dialog modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="expenseCategoryModalLabel">
