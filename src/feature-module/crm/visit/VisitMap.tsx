...
const VisitMap = () => {
  ...
  const [dateFrom, setDateFrom] = useState<Date | null>(defaultDates.from);
  const [dateTo, setDateTo] = useState<Date | null>(defaultDates.to);
            ...
            <div className="card-body">
              <div className="row g-3 align-items-end">
                <div className="col-md-3 col-lg-3">
                  <label className="form-label small text-muted mb-1 fw-medium">Date From</label>
                  <DatePicker
                    selected={dateFrom}
                ...
                <div className="col-md-3 col-lg-3">
                  <label className="form-label small text-muted mb-1 fw-medium">Date To</label>
                  <DatePicker
                    selected={dateTo}
                ...
                <div className="col-md-4 col-lg-3">
                  <label className="form-label small text-muted mb-1 fw-medium">Employee</label>
                  <select
                ...
                <div className="col-md-2 col-lg-3 text-end">
                  ...
                  <button
                    className="btn btn-primary w-100 w-lg-auto d-inline-flex align-items-center justify-content-center"
                    onClick={() => fetchVisits()}
                    disabled={loading}
                  >
                    {loading ? (
            ...
            <div className="col-md-4">
              <div className="card">
                <div className="card-header bg-white border-bottom">
                  <h5 className="mb-1">Visits with Check-in</h5>
                  <p className="text-muted mb-0 small">
                    <i className="ti ti-info-circle me-1" /> Only visits with check-in locations are shown
                  </p>
                </div>
