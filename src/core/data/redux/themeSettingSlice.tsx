...
// Always set sidebar color to darkgreen permanently
const defaultSidebar = "darkgreen";
localStorage.setItem("dataSidebar", "darkgreen");
if (typeof document !== "undefined" && document.documentElement) {
  document.documentElement.setAttribute("data-sidebar", "darkgreen");
  document.documentElement.setAttribute("data-loader", "disable");
}
...
const themeSettingSlice = createSlice({
  ...
  reducers: {
    ...
    setDataSidebar: (state, action) => {
      // Always force sidebar to darkgreen
      const sidebarColor = "darkgreen";
      state.dataSidebar = sidebarColor;
      localStorage.setItem("dataSidebar", sidebarColor);
    ...
    setLoader: (state, action) => {
      // Always force loader to disable
      const loaderState = "disable";
      state.dataLoader = loaderState;
      localStorage.setItem("dataLoader", loaderState);
      document.documentElement.setAttribute("data-loader", loaderState);
    },
    setRtl: (state, action) => {
