...
const ThemeSettings = () => {
  ...
  const [colorRgb, setColorRgb] = useState<Color>(dataSidebarAll ? `rgb(${dataSidebarAll})` : 'rgb(128, 128, 128)');
  const [colorRgb2, setColorRgb2] = useState<Color>(dataTopbarAll ? `rgb(${dataTopbarAll})` : 'rgb(128, 128, 128)');
  const [colorRgb3, setColorRgb3] = useState<Color>(dataTopBarColorAll ? `rgb(${dataTopBarColorAll})` : 'rgb(128, 128, 128)');
  const [colorRgb4, setColorRgb4] = useState<Color>(dataColorAll ? `rgb(${dataColorAll})` : 'rgb(128, 128, 128)');
...
useEffect(() => {
  ...
  useEffect(() => {
    ...
    setColorRgb(dataSidebarAll ? `rgb(${dataSidebarAll})` : 'rgb(128, 128, 128)')
    setColorRgb2(dataTopbarAll ? `rgb(${dataTopbarAll})` : 'rgb(128, 128, 128)')
    setColorRgb3(dataTopBarColorAll ? `rgb(${dataTopBarColorAll})` : 'rgb(128, 128, 128)')
    setColorRgb4(dataColorAll ? `rgb(${dataColorAll})` : 'rgb(128, 128, 128)')
            ...
            <div id="layoutsetting" className="accordion-collapse collapse show">
              <div className="accordion-body">
                <div className="row gx-3">
                  ...
                  <div className="col-4">
                    <Link to={all_routes.layoutRtl} className="theme-layout mb-3" onClick={() => dispatch(setRtl('layout-mode-rtl'))}>
                      <span className="d-block mb-2 layout-img">
